...
import giveImage1 from "@/assets/Give Image 1.jpg";
  ...
  head: () => ({
    meta: [
      { title: "Give — Hope For Life Ministry" },
      {
        name: "description",
        content:
          "Partner with the mission of Hope For Life Ministry through generous, joyful giving.",
      },
  ...
  return (
    <>
      <PageHeader
        eyebrow="Generosity"
        title="Give with joy."
        subtitle="Every gift — large or small — fuels worship, discipleship, outreach, and care for those in need. Thank you for partnering with us."
      />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-muted-foreground leading-relaxed">
              <p>
                Giving is a response to God's overwhelming grace toward us in Christ. We don't give
                to earn anything; we give because we have been given everything in Jesus.
              </p>
              <p>
                Your generosity makes possible our weekly worship, our care for the hurting, our
                outreach to Springfield, and our support of missionaries around the world.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                Icon: CreditCard,
                t: "Give Online",
                d: "One-time or recurring gifts via debit, credit, or bank transfer. Secure and instant.",
                cta: "Give Now",
              },
              {
                Icon: Heart,
                t: "Give In Person",
                d: "Drop your gift in the offering during any Sunday service. Envelopes provided.",
                cta: "Service Times",
              },
              {
                Icon: Building2,
              ...
              <div
                key={t}
                className="group relative bg-card p-10 text-center rounded-3xl border border-border/50 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
