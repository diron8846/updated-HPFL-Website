...
const cardVariants = cva(
  "relative flex flex-col justify-between h-full w-full overflow-hidden rounded-2xl p-8 shadow-sm transition-shadow duration-300 hover:shadow-lg",
  {
    variants: {
      gradient: {
        orange: "bg-gradient-to-br from-orange-100 to-amber-200/50 dark:from-orange-950 dark:to-amber-900/30",
        gray: "bg-gradient-to-br from-slate-100 to-slate-200/50 dark:from-slate-900 dark:to-slate-800/30",
        purple: "bg-gradient-to-br from-purple-100 to-indigo-200/50 dark:from-purple-950 dark:to-indigo-900/30",
        green: "bg-gradient-to-br from-emerald-100 to-teal-200/50 dark:from-emerald-950 dark:to-teal-900/30",
      },
    },
    defaultVariants: {
      gradient: "gray",
      ...
      >
        ...
        >
          ...
          <motion.img
            ...
            className="absolute -right-1/4 -bottom-1/4 w-3/4 opacity-80 pointer-events-none dark:opacity-30 mix-blend-multiply dark:mix-blend-overlay"
          />
